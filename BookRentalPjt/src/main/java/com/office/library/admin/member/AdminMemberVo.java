...
public class AdminMemberVo {
	...
	public String toString() {
		return "AdminMemberVo [a_m_no=" + a_m_no + ", a_m_approval=" + a_m_approval + ", a_m_id=" + a_m_id + ", a_m_pw="
				+ a_m_pw + ", a_m_name=" + a_m_name + ", a_m_gender=" + a_m_gender + ", a_m_part=" + a_m_part
				+ ", a_m_position=" + a_m_position + ", a_m_mail=" + a_m_mail + ", a_m_phone=" + a_m_phone
				+ ", a_m_reg_date=" + a_m_reg_date + ", a_m_mod_date=" + a_m_mod_date + "]";
	}
